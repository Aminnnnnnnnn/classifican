...
datadir="C:/SE modeling/all/train/"    # the path of training images
CATEGORIES=['bic','car','ped','truck'] # there are 4 folder of  pictures
...
# Prepar testin data
datadirr="C:/SE modeling/all/test/" # the path of testing images
test_data=[]
def creat_test_data():
    for category in CATEGORIES:
...
# predict bic=0 car=1 ped=2  truck=3
